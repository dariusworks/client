	...
	return rpc.Protocol{
		...
		Methods: map[string]rpc.ServeHandlerDescription{
			...
			"simpleFSGetRevisions": {
				MakeArg: func() interface{} {
					ret := make([]SimpleFSGetRevisionsArg, 1)
					return &ret
				},
				Handler: func(ctx context.Context, args interface{}) (ret interface{}, err error) {
					typedArgs, ok := args.(*[]SimpleFSGetRevisionsArg)
					if !ok {
						err = rpc.NewTypeError((*[]SimpleFSGetRevisionsArg)(nil), args)
						return
					}
			...
			"simpleFSReadRevisions": {
				MakeArg: func() interface{} {
					ret := make([]SimpleFSReadRevisionsArg, 1)
					return &ret
				},
				Handler: func(ctx context.Context, args interface{}) (ret interface{}, err error) {
					typedArgs, ok := args.(*[]SimpleFSReadRevisionsArg)
					if !ok {
						err = rpc.NewTypeError((*[]SimpleFSReadRevisionsArg)(nil), args)
						return
					}
